     ...
     names = snippet.scan(pattern).map do
        ...
        def craft_params(rand_words, snippet, pattern)
            ...
            def convert(snippet, phrase)
                rand_word = WORDS.sort_by {rand}
                class_names = craft_names(rand_word, snippet, /###/, caps=true)
                other_names = craft_names(rand_word, snippet, /\*\*\*/)
                param_names = craft_params(rand_word, snippet, /@@@/)
